        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6 col-md-6 col-sm-4">
				...
				<div class="form-group">
                 ...
                 <div class="form-group">
                        <label class="control-label" for="choose ">Role</label>
                       <br/>
                        <select name="role">
                            <option value="Chief Security Officer">Chief Security Officer</option>
                            <option value="Deputy CSO">Deputy Chief Security Officer</option>
                            <option value="Operational Security Officer">Operational Security Officer</option>
